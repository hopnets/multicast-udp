// Userspace TCP Reno unicast sender over UDP, modified to include benchmarks.
// (note: comments not updated since this was copied over from reno_sender.cpp)
//
// Protocol:
...
struct BenchResultsFragment {
    uint64_t time_to_completion;
